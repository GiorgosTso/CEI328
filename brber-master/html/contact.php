                    ...
                    <div class="col-lg-8">
                        <form action=<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> method="post" >
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control <?php echo (!empty($email_err)) ? 'is-invalid' : ''; ?> valid" name="email" id="email" type="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" placeholder="Email">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                            ...
                            <div class="form-group mt-3">
                                <input type="submit" class="button button-contactForm boxed-btn" value="Send"></input>
                            </div>
                        </form>
                    </div>
