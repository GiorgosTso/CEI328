...
if(!empty($email) && !empty($password) && empty($email_err))
{
    ...
    <div class="mask d-flex align-items-center h-100 gradient-custom-3" style="position: relative; top: -350px; ">
      ...
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
        <p style="color: black;">Τα πεδία με <span class="red-asterisk">*</span> είναι υποχρεωτικά παρακαλώ όπως τα συμπληρώσετε.<br> 
          ...
          <div class="col-md-12">
            <div class="form-floating mb-3 mb-md-3">
            <p style="color: black;"><label for="email"> <span class="red-asterisk">*</span>Email:</label>
            <input class="form-control <?php echo (!empty($email_err)) ? 'is-invalid' : ''; ?>" id="email" name="email" type="email" placeholder="Εmail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required />
